...
class SharelistClientDetailView extends Component {
...
const selector = formValueSelector('sharelistClientEditForm')
SharelistClientDetailView = reduxForm({
  form: 'sharelistClientEditForm',
  enableReinitialize: true
})(SharelistClientDetailView);

SharelistClientDetailView = connect(
  state => {
...
export default SharelistClientDetailView;
